...
export default function Footer() {
  return (
    <footer className="bg-muted text-muted-foreground border-t border-border/40">
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8"> {/* Changed py-10 to py-8 */}
        ...
        <div className="mt-8 border-t border-border/60 pt-4 text-center"> {/* Changed mt-10 to mt-8 and pt-6 to pt-4 */}
          <p className="text-sm">
