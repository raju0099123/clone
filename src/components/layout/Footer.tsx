    ...
    <footer className="bg-muted text-muted-foreground border-t border-border/40">
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <Link href="/" className="flex items-center justify-center md:justify-start gap-2 mb-4" prefetch={false}>
              <Image
          ...
          <div>
            <h3 className="text-lg font-semibold text-foreground mb-4 text-center md:text-left">Quick Links</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold text-foreground mb-4 text-center md:text-left">Legal</h3>
            <ul className="space-y-2 text-sm">
